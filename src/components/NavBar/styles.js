...
export const Configs = styled(Settings)`
    ...
    position: absolute;
    color: ${({isOpen, theme}) => (
        isOpen ? theme.color.hoverColorText : theme.color.textColor
    )};
`;
...
export const CustomerButtons = styled.button`
    ...
    background-color: ${props => props.isOpen ? props.theme.color.hoverColorBg : props.theme.color.thirtyColor};
...
export const NavBar = styled.nav`
    ...
    z-index: 10;
    padding: 15px;
    box-shadow: rgba(50, 50, 93, 0.25) 15px 13px 27px -5px, rgba(0, 0, 0, 0.3) 15px 8px 16px -8px;
